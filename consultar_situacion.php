...
$datos_situacion=$bd->consultaObjeto(array("*")," condicion","1",0);
?>
<!DOCTYPE html>
<html>
<head>
...
<div id='contenido_principal'>			
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Consultar Situaci&oacute;n de Equipos</h1>
			</div>
		</div><!--/.row-->
...
<table id="example" class="display table-hover dt-responsive" cellspacing="0" width="100%">
        ...
        <tbody>
           <?php for($i=0;$i<sizeof($datos_situacion);$i++){?>
		   
		    <tr>

               
				<td><?php echo $datos_situacion[$i]->DESCRIPCION;?></td>
				<td><?php echo $datos_situacion[$i]->FECHA_TRANS ;?></td>
				<td><a  onClick="editar('<?php echo $datos_situacion[$i]->ID_CONDICION;?>')"><span class="glyphicon glyphicon-pencil" title="Editar"></span></a></td>
...
function editar($id){
			...
			var parametros = {
			"id_situacion_equipo"   	   : $id
			};

			 $.ajax({
                data:  parametros,
                url:   'editar_situacion.php',
                type:  'POST',
                beforeSend: function () {
