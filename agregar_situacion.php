...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Agregar Situaci&oacute;n de Equipo</h1>
			</div>
		</div><!--/.row-->
...
<input type="text" id="descripcion"  name="descripcion" value="" size="40" class="form-control" placeholder=" * Situaci&oacute;n del Equipo" onKeyUp="javascript:this.value=this.value.toUpperCase();"/>
</div>
		...
		var V_DESCRPCION = $("#descripcion").val();
		   ...
		   var parametros = {
			"descripcion"  : V_DESCRPCION
			 ...
			 $.ajax({
                data:  parametros,
                url:   'proc_ingresar_situacion.php',
                type:  'POST',
                beforeSend: function () {
