...
<div class="form-group"> 
<strong> Tipo de Mantenimiento</strong><br>
<div class="form-group"> <input type="radio" name="Mtto_correct_prevent"  value="Preventivo"/> Preventivo</div>
<div class="form-group"> <input type="radio" name="Mtto_correct_prevent"  value="Correctivo"/> Correctivo</div>
</div>
<div class="form-group"> 
<strong> Fecha del ultimo Mantenimiento</strong><br>
<input type="date" id="ult_mtto"  name="ult_mtto" value="" size="40" class="form-control" class="Fecha" onKeyUp="javascript:this.value=this.value.toUpperCase();"/>
</div>
</div>
...
<div class="form-group"> 
<strong> Tipo de Mantenimiento</strong><br>
<div class="form-group"> <input type="radio" name="Mtto_correct_prevent" class="ids" value="Preventivo"/> Preventivo</div>
<div class="form-group"> <input type="radio" name="Mtto_correct_prevent" class="ids" value="Correctivo"/> Correctivo</div>
</div>
<div class="form-group"> 
<strong> Fecha del ultimo Mantenimiento</strong><br>
<input type="date" id="ult_mtto"  name="ult_mtto" value="" size="40" class="form-control" class="Fecha" onKeyUp="javascript:this.value=this.value.toUpperCase();"/>
...
<label for="imagen_i" generated="true" class="error"></label>
 ...
 var res = sel.value.split("-");
	  ...
	  if (res[1]=="PC"){
	   ...
	   if (res[1]!="MOUSE" && res[1]!="MONITOR" && res[1]!="PC" && res[1]!="LAPTOP" && res[1]!="IMPRESORA"  ){
		  $("#esp_otro").show();
           $("#espe_pc").hide();
		   $("#espe_mouse").hide();
		   $("#espe_monitor").hide();
