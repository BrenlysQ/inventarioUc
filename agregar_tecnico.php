...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Agregar T&eacute;cnico de Equipo</h1>
			</div>
		</div><!--/.row-->
...
<input type="text" id="nombre_tec"  name="nombre_tec" value="" size="40" class="form-control" placeholder=" * Nombre del T&eacute;cnico" onKeyUp="javascript:this.value=this.value.toUpperCase();"/>
</div>

<div class="form-group">
<input type="text" id="usuario_tec"  name="usuario_tec" value="" size="40" class="form-control" placeholder=" * Usuario del T&eacute;cnico" onKeyUp="javascript:this.value=this.value.toUpperCase();"/>
</div>
