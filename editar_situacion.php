...
$datos_situacion_equipo=$bd->consultaObjeto(array("*"),"condicion","ID_CONDICION='".$_POST['id_situacion_equipo']."'",0);
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Editar Situaci&oacute;n de Equipo</h1>
			</div>
		</div><!--/.row-->
...
<input type="text" id="descripcion"  name="descripcion" value="<?php echo $datos_situacion_equipo[0]->DESCRIPCION?>" size="40" class="form-control" placeholder=" * Situaci&oacute;n del Equipo" onKeyUp="javascript:this.value=this.value.toUpperCase();"/>
</div>
  </div>
</div>
	
	<input id="id_situacion_equipo" name="id_situacion_equipo" type="hidden" value="<?php echo $datos_situacion_equipo[0]->ID_CONDICION;?>">	
 ...
 $(document).ready(function () {
     $('#formulario').validate({ // initialize the plugin
       ...
       rules: {
        ...
        messages: {
			...
			"descripcion": { 
				required: "Debe introducir la Situaci&oacute;n del Equipo."				
			}
	 ...
	 submitHandler: function (form) { // for demo
		...
		var V_ID_SITUACION = $("#id_situacion_equipo").val();
				
		
		   var parametros = {
			"descripcion"  : V_DESCRPCION,
			"id_situacion_equipo":V_ID_SITUACION

			};

			 $.ajax({
                data:  parametros,
                url:   'proc_editar_situacion.php',
                type:  'POST',
                beforeSend: function () {
